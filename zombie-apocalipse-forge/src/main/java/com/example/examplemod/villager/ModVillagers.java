...
public class ModVillagers {
    ...
    public static final RegistryObject<PoiType> APOCALIPSE_POI = POI_TYPES.register("apocalipse_poi",
            () -> new PoiType(ImmutableSet.copyOf(ModBlocks.APOCALIPSE_TRADING_STATION_BLOCK.get().getStateDefinition().getPossibleStates()),
                    1, 1));

    public static final RegistryObject<VillagerProfession> APOCALIPSE_MASTER =
            VILLAGER_PROFESSIONS.register("apocalipsemaster", () -> new VillagerProfession("apocalipsemaster",
